...
if choice == "Store Secret":
    ...
    if st.button("Enrypt and Save"):
        if label and secret and passkey:
            ...
            try:
                c.execute("INSERT INTO value (label , encrypted_text , passkey) VALUES (?, ?, ?)", (label, encrypted, hashed_key))
            ...
            st.warning("Plese fill all fields")

elif choice == "Retrieve Secret":
    st.header("Retrives Your Scret")
